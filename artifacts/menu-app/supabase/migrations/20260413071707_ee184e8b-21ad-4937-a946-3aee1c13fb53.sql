...
CREATE TABLE public.books (
  ...
  cover_url TEXT,
  genre TEXT NOT NULL,
  type TEXT NOT NULL DEFAULT 'libro' CHECK (type IN ('libro', 'audiolibro')),
  is_premium BOOLEAN NOT NULL DEFAULT false,
  file_url TEXT,
...
BEGIN
  ...
  VALUES (NEW.id, COALESCE(NEW.raw_user_meta_data->>'full_name', NEW.raw_user_meta_data->>'name', 'Usuario'), COALESCE(NEW.raw_user_meta_data->>'avatar_url', NULL));
